...
from src.query.executor import fetch_all, execute_raw
...
async def get_related_records(
  ...
  logger.info('fetching_related_records', record=record_str, edge_table=edge_table, target_table=target_table)
