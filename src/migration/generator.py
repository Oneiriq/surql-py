...
from src.migration.diff import diff_tables, diff_edges
from src.migration.models import SchemaDiff
...
def generate_migration(
  ...
  description: str,
  *,
  old_tables: Optional[dict[str, TableDefinition]] = None,
  new_tables: Optional[dict[str, TableDefinition]] = None,
  old_edges: Optional[dict[str, EdgeDefinition]] = None,
  new_edges: Optional[dict[str, EdgeDefinition]] = None,
  author: str = 'ethereal',
) -> Path:
...
def generate_initial_migration(
  ...
  edges: Optional[dict[str, EdgeDefinition]] = None,
...
def generate_migration_from_diffs(
  ...
  try:
    ...
    raise MigrationGenerationError(
      f'Failed to generate migration from diffs: {e}'
    ) from e
