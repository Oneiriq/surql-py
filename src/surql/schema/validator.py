...
from surql.schema.utils import fetch_db_tables
...
async def _fetch_db_tables(client: 'DatabaseClient') -> dict[str, TableDefinition]:
  ...
  # (tests can patch surql.schema.validator.parse_table_info)
...
from surql.schema.validator_utils import (  # noqa: E402, F401
  filter_by_severity,
  filter_errors,
  filter_warnings,
