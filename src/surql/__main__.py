...
@app.command()
def version() -> None:
  """Show surql version information."""
  settings = get_settings()
  console.print(f'[bold cyan]surql[/bold cyan] version {settings.version}')
...
def main(
  ...
  surql provides a modern, type-safe way to work with SurrealDB through:
