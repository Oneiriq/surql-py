"""Cache backend implementations for surql.
...
class RedisCache(CacheBackend):
  ...
  Note:
      ...
      Install with: pip install surql[cache]
  ...
  def __init__(
    ...
    Args:
        url: Redis connection URL.
        prefix: Prefix for all cache keys (default: "surql:").
        default_ttl: Default TTL in seconds (default: 5 minutes).
    ...
    try:
      ...
      raise ImportError(
        ...
        'Install it with: pip install surql[cache]'
      ) from e
