"""Query result caching module for reverie.
...
from reverie.cache.config import CacheConfig, CacheOptions, CacheStats
from reverie.cache.decorator import cache_key_for, cache_query, is_cached
from reverie.cache.manager import CacheManager
